var creatorABI = [
  ...
  //   web3.eth.getTransactionReceipt("0x35b10468ea0c7367eb841fa88c30b56e516c33d1497bb1d48735280c60dab51e",
  // (error, result) => {
  //   console.log("getTransactionReceipt="+result.logs);
  // });

  // web3.eth.getTransactionReceipt("0x2ad5c3f027edbc3d0901dea3677dcf5882ed33f303f322096e0c1617277c53da",
  // (error, result) => {
  //   console.log("getTransactionReceipt="+result.logs);
  // });
  ...
  window.loadBallot = function() {
        ...
        creatorContract.getAddress(ballotID, (error, result) => {
            ...
            if(votingAddress == 0) {  // コントラクトアドレスが0の場合エラー
